...
S = MG MGU{( $\begin{array} { r l } & { U \{ ( X _ { 1 } \to X _ { 2 } \to X _ { 2 } ) \to X _ { 2 } \to [ X _ { 1 } ] \to X _ { 2 } \stackrel { ? } { = } ( ( X _ { 3 } \to X _ { 4 } ) } \\ & { \leqslant _ { 1 } \to X _ { 2 } \to X _ { 2 } ) \to X _ { 2 } \to [ X _ { 1 } ] \to X _ { 2 } \stackrel { ? } { = } ( ( X _ { 3 } \to X _ { 4 } ) ~ . } \end{array}$ X4) → [X3] → [X4]) → → [X3] → [X4]) → X5}   
...
S ${ \begin{array} { r l } & { = M G U \{ ( X _ { 1 } \to X _ { 2 } \to X _ { 2 } ) \to X _ { 2 } \to [ X _ { 1 } ] \to X _ { 2 } } \\ & { = \{ X _ { 1 } : = X _ { 3 } \to X _ { 4 } , X _ { 2 } : = [ X _ { 3 } ] , X _ { 3 } : = X _ { 4 } , X _ { 5 } : = [ X _ { 4 } ] } \\ & { = \{ X _ { 1 } : = X _ { 4 } \to X _ { 4 } , X _ { 2 } : = [ X _ { 4 } ] , X _ { 3 } : = X _ { 4 } , X _ { 5 } : = [ X _ { 4 } ] \} } \end{array} }$ → X4) → [X3] → [X4]) → X5} [X4] → [X4 → X4] → [X4]} [X4] → [X4 → X4] → [X4]}   
= X4] → [X4 → X4] → [X4]}
