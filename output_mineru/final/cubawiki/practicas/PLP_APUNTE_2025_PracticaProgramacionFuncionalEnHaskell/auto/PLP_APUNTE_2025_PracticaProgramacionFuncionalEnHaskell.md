...
$$
\begin{array} { r } { \mathrm { p r o d } ^ { \prime } \mathrm { ~  ~ \vec { ~ } { ~ x ~ } ~ } = } \end{array}
$$
...
1 ¿Cu´al es el tipo de doble? $\boldsymbol { \Theta }$ ¿Qu´e pasa si cambiamos la definici´on por doble $=$ prod 2?
