...
$$
\begin{array} { c c } { { \tau , \sigma , \rho , \ldots } } & { { \mathrel { \mathop : } \mathrel { : } = } } & { { { \sf b o o l } } } \\ { { \mid } } & { { \tau \to \sigma } } \end{array}
$$
...
$$
{ \begin{array} { r l } & { { \mathrm { E j e m p l o s ~ d e ~ t e r m i n o s } } } \\ { * } & { \lambda x : { \mathrm { b o o l } } . x } \\ { * } & { \lambda x : { \mathrm { b o o l } }  { \mathrm { b o o l } } . x } \\ { * } & { ( \lambda x : { \mathrm { b o o l } } . x ) { \mathrm { f a l s e } } } \\ { * } & { ( \lambda x : { \mathrm { b o o l } }  { \mathrm { b o o l } } . x ) ( \lambda y : { \mathrm { b o o l } } . y ) } \\ { * } & { ( \lambda x : { \mathrm { b o o l } } . \lambda y : { \mathrm { b o o l } }  { \mathrm { b o o l } } . y ) { \mathrm { t r } } } \\ { * } & { \lambda x : { \mathrm { b o o l } } . { \mathrm { i f ~ } } x { \mathrm { ~ t h e n ~ f a l s e ~ e l s e ~ t r u e } } } \\ { * } & { { \mathrm { t r u e ~ t r u e } } } \end{array} }
$$
...
A veces notamos dom $\mathfrak { r } ( \Gamma ) = \{ x _ { 1 } , \dots , x _ { n } \}$
...
![](images/442f8ffb722d2068862059d3c824157f66f9b1437c02d93092b91a9d1642fa7c.jpg)
...
$\frac { M \to M ^ { \prime } } { M N \to M ^ { \prime } N } \mathrm { E \mathrm { - } A P P 1 }$ $\begin{array} { c } { { N  N ^ { \prime } } } \\ { { \overline { { { \lambda x : \tau . M ) N  ( \lambda x : \tau . M ) N ^ { \prime } } } } ^ { \mathrm { E - A P P 2 } } } } \\ { { { } } } \\ { { \overline { { { \lambda x : \tau . M ) V  M \{ x : = V \} } } } ^ { \mathrm { E - A P P A B S } } } } \end{array}$
...
M ::= zero el n´umero cero succ(M) el sucesor del n´umero que representa M pred(M) el predecesor del n´umero que representa M isZero(M) representa un booleano true/false, dependiendo de si M representa al cero o n

$$
\mathsf { E } | \mathsf { c } \mathsf { \bar { a } } | \mathsf { c } \mathsf { u } | \mathsf { o } \lambda ^ { b n } \mathrm { : \ r e g } | \mathsf { a } \mathsf { s \ d e \ t i p a d { o } }
$$
...
$\begin{array} { r l } & { \xrightarrow { M  M ^ { \prime } } \mathrm { E - S U C C } } \\ & { \xrightarrow { \mathrm { s u c c } ( M )  \mathrm { s u c c } ( M ^ { \prime } ) } \mathrm { E - S U C C } } \\ & { \xrightarrow { M  M ^ { \prime } } \mathrm { E - P R E D } } \end{array}$ e-predSucc   
...
En el c´alculo- $\lambda ^ { b }$ s´ı. En el c´alculo- $\lambda ^ { b n }$ no. (¿Qu´e propiedad deja de valer?)
