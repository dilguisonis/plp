...
La cl´ausula objetivo $\cdot$ est´a fijada, no hay alternativas.   
...
$$
\begin{array} { r l } { \boxed { 1 } } & { \left\{ \mathsf { a } ( 0 , \mathsf { X } , \mathsf { X } ) \right\} } \\ { \boxed { 2 } } & { \left\{ \lnot \mathrm { a } ( \mathrm { X } , \mathrm { Y } , \mathrm { Z } ) , \mathsf { a } ( \mathbf { s } ( \mathrm { X } ) , \mathrm { Y } , \mathbf { s } ( \mathrm { Z } ) ) \right\} } \\ { \textsf { \textsf { B } } } & { \left\{ \lnot \mathrm { a } ( \mathbf { s } ( 0 ) , \mathrm { X } , \mathbf { s } ( \mathbf { s } ( 0 ) ) ) \right\} } \end{array}
$$
...
$$
\begin{array} { r l } & { \mathsf { P o r } \left[ 3 \right] \mathsf { y } \left[ 2 \right] = \{ \neg { \mathsf { a } } ( \mathrm { X } _ { 2 } , \mathrm { Y } _ { 2 } , \mathrm { Z } _ { 2 } ) \} } \\ & { \mathsf { S } _ { 4 } = \{ \mathrm { X } _ { 2 } : = 0 , \mathrm { X } _ { 3 } : = \mathrm { Y } _ { 2 } , \mathrm { Z } _ { 2 } : = \mathsf { s } ( \mathsf { s } ( 0 ) ) \} } \\ & { \frac { \prod } { 4 } = \{ \neg { \mathsf { a } } ( 0 , \mathrm { Y } _ { 4 } , \mathrm { s } ( \mathsf { s } ( 0 ) ) ) \} . } \\ & { \frac { \prod } { 4 } \mathsf { y } \left[ 1 \right] = \{ \} } \\ & { \mathsf { S } _ { 5 } = \{ \mathsf { Y } _ { 4 } : = \mathsf { s } ( \mathsf { s } ( 0 ) ) , \mathrm { X } _ { 1 } : = \mathsf { s } ( \mathsf { s } ( 0 ) ) \} } \\ & { \mathsf { S } _ { 7 } = \{ \} } \end{array}
$$
...
$$
\begin{array} { c c c c c c } { { G _ { 1 } \stackrel { { \bf S } _ { 1 } } {  } } } & { { G _ { 2 } \stackrel { { \bf S } _ { 2 } } {  } } } & { { \cdots } } & { { G _ { n - 1 } \stackrel { { \bf S } _ { n - 1 } } {  } } } & { { G _ { n } } } \\ { { C _ { 1 } \stackrel { \prime } {  } } } & { { C _ { 2 } \stackrel { \prime } {  } } } & { { } } & { { C _ { n - 1 } } } & { { \stackrel { \prime } {  } } } \end{array}
$$
...
Si $\{ D _ { 1 } , \ldots , D _ { n } , \quad \}$ es insatisfactible, existe una refutaci´on SLD.
